...
public class ResponseInfo<T> {
    ...
    public void wrapSuccess(T content, CoreMsgs coreMsg) {
        wrapSuccess(content, coreMsg.getMessage());
    }
    ...
    public void wrapFail(CoreMsgs coreMsg) {
        wrapFail(null, coreMsg);
    }

    public void wrapFail(T content, CoreMsgs coreMsg) {
        wrapFail(content, coreMsg.getMessage());
    }
    ...
    public void wrapError() {
        wrapError(MessageErrors.SYSTEM_ERROR.getMessage());
    }
